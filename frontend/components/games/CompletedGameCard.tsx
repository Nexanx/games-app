        ...
        <CardContent className="grid grid-cols-[72px_minmax(0,1fr)] gap-3 p-3 sm:grid-cols-[88px_1fr] sm:gap-4 sm:p-4">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-3 grid gap-2 text-sm sm:grid-cols-2 xl:grid-cols-4">
              ...
              <Metric icon={Star} label="Moja ocena" value={entry.rating == null ? "Bez oceny" : `${entry.rating}/10`} />
              <Metric icon={BarChart3} label="Metacritic" value={metacriticValueLabel(entry.game.external_ratings)} />
            </div>
