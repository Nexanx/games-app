...
describe("GameCover helpers", () => {
  it("uses a RAWG-supported derivative for search thumbnails", () => {
    expect(getGameCoverSource("https://media.rawg.io/media/games/abc/cover.jpg", "thumbnail")).toBe(
      "https://media.rawg.io/media/resize/200/-/games/abc/cover.jpg"
    );
  });
