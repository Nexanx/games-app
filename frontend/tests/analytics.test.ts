...
const dashboard: CompletedGamesYearDashboard = {
  ...
  most_active_month: { month: 7, completed_games_count: 2, total_playtime_hours: 30, games_with_playtime_count: 2, average_rating: 9, rated_games_count: 1, unique_platforms_count: 1, unique_genres_count: 1 },
